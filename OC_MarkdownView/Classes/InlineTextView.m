...
//    NSLog(@"relayoutText begin");
    [self.textLayoutManager enumerateTextLayoutFragmentsFromLocation:self.textContentManager.documentRange.location options:NSTextLayoutFragmentEnumerationOptionsEnsuresLayout usingBlock:^BOOL(NSTextLayoutFragment * _Nonnull layoutFragment) {
...
- (void)touchesEnded:(NSSet<UITouch *> *)touches withEvent:(UIEvent *)event
{
    ...
    {
        [line.attributedString enumerateAttribute:kURLInMarkDownKey inRange:NSMakeRange(0, [line.attributedString length]) options:NSAttributedStringEnumerationReverse usingBlock:^(id  _Nullable value, NSRange range, BOOL * _Nonnull stop) {
